...
player1.src = 'Media/messi.png';
const player2 = new Image();
player2.src = 'Media/ronaldo.png'
...
function endGame(){
    if(parseInt(player_score.innerHTML) == parseInt(enemy_score.innerHTML))
        end.innerHTML = "DRAW<br>ANYWAY<br>MESSI WINS";
    else if(parseInt(player_score.innerHTML) > parseInt(enemy_score.innerHTML))
        end.innerHTML = "Winner<br>"
    else (parseInt(player_score.innerHTML) < parseInt(enemy_score.innerHTML))
